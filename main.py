...
def hello_http(request):
    ...
    if request_json and 'img' in request_json:
        ...
        # img = 'https://demofree.sirv.com/nope-not-here.jpg'
    ...
    if lang != "en-US":
        ...
        for translation in translatedText.translations:
            speechText = u"{}".format(translation.translated_text)
            break
    
    # return (translatedText.translations["translated_text"], 200, headers)
    return ([speechText], 200, headers)
